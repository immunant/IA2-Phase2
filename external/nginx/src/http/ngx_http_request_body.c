...
IA2_DECLARE_WRAPPER(ngx_http_block_reading, _ZTSPFvP18ngx_http_request_sE, 1);
    ...
    ngx_http_client_body_handler_pt post_handler)
{
    ...
    if (r != r->main || r->request_body || r->discard_body) {
        ...
        IA2_CALL(post_handler, _ZTSPFvP18ngx_http_request_sE, 1)(r);
        return NGX_OK;
    }
    ...
    if (preread) {
            ...
            && rb->rest <= (off_t) (r->header_in->end - r->header_in->last))
        {
            ...
            r->read_event_handler = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_read_client_request_body_handler, _ZTSPFvP18ngx_http_request_sE, 1);
    ...
    r->read_event_handler = IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_http_read_client_request_body_handler, _ZTSPFvP18ngx_http_request_sE, 1);
    r->write_event_handler = IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_http_request_empty_handler, _ZTSPFvP18ngx_http_request_sE, 1);
...
ngx_http_do_read_client_request_body(ngx_http_request_t *r)
{
    ...
    for ( ;; ) {
        for ( ;; ) {
            ...
            n = IA2_CALL(c->recv, _ZTSPFlP16ngx_connection_sPhmE, 1)(c, rb->buf->last, size);
    ...
    if (!r->request_body_no_buffering) {
        r->read_event_handler = IA2_WRAPPER_FN_SCOPE(ngx_http_block_reading, 1);
        IA2_CALL(rb->post_handler, _ZTSPFvP18ngx_http_request_sE, 1)(r);
    }
...
ngx_http_read_discarded_request_body(ngx_http_request_t *r)
{
    ...
    for ( ;; ) {
        ...
        n = IA2_CALL(r->connection->recv, _ZTSPFlP16ngx_connection_sPhmE, 1)(r->connection, buffer, size);
...
ngx_http_test_expect(ngx_http_request_t *r)
{
    ...
    n = IA2_CALL(r->connection->send, _ZTSPFlP16ngx_connection_sPhmE, 1)(r->connection,
...
ngx_http_request_body_length_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    rc = IA2_CALL(ngx_http_top_request_body_filter, _ZTSPFlP18ngx_http_request_sP11ngx_chain_sE, 1)(r, out);
