...
IA2_DEFINE_WRAPPER(ngx_http_scgi_pass, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_http_scgi_store, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
...
#if (NGX_HTTP_CACHE)
IA2_DEFINE_WRAPPER(ngx_http_scgi_cache, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_http_scgi_cache_key, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
#endif
...
static ngx_command_t ngx_http_scgi_commands[] = {
    ...
    { ngx_string("scgi_pass"),
      ...
      IA2_WRAPPER(ngx_http_scgi_pass, 1),
    ...
    { ngx_string("scgi_store"),
      ...
      IA2_WRAPPER(ngx_http_scgi_store, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("scgi_cache"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      IA2_WRAPPER(ngx_http_scgi_cache, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("scgi_cache_key"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      IA2_WRAPPER(ngx_http_scgi_cache_key, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
...
IA2_DEFINE_WRAPPER(ngx_http_scgi_create_main_conf, _ZTSPFPvP10ngx_conf_sE, 1);
IA2_DEFINE_WRAPPER(ngx_http_scgi_create_loc_conf, _ZTSPFPvP10ngx_conf_sE, 1);
IA2_DEFINE_WRAPPER(ngx_http_scgi_merge_loc_conf, _ZTSPFPcP10ngx_conf_sPvS2_E, 1);

static ngx_http_module_t ngx_http_scgi_module_ctx = {
    IA2_NULL_FNPTR,                                  /* preconfiguration */
    IA2_NULL_FNPTR,                                  /* postconfiguration */

    IA2_WRAPPER(ngx_http_scgi_create_main_conf, 1),        /* create main configuration */
    ...
    IA2_WRAPPER(ngx_http_scgi_create_loc_conf, 1),         /* create location configuration */
    IA2_WRAPPER(ngx_http_scgi_merge_loc_conf, 1)           /* merge location configuration */
};
...
ngx_http_scgi_handler(ngx_http_request_t *r)
{
    ...
    u->create_key = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_create_key, _ZTSPFlP18ngx_http_request_sE, 1);
#endif

    u->create_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_create_request, _ZTSPFlP18ngx_http_request_sE, 1);
    u->reinit_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_reinit_request, _ZTSPFlP18ngx_http_request_sE, 1);
    u->process_header = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_process_status_line, _ZTSPFlP18ngx_http_request_sE, 1);
    u->abort_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_abort_request, _ZTSPFvP18ngx_http_request_sE, 1);
    u->finalize_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_finalize_request, _ZTSPFvP18ngx_http_request_slE, 1);
    r->state = 0;
    ...
    u->pipe->input_filter = IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_event_pipe_copy_input_filter, _ZTSPFlP16ngx_event_pipe_sP9ngx_buf_sE, 1);
    u->pipe->input_ctx = r;

    u->input_filter_init = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_input_filter_init, _ZTSPFlPvE, 1);
...
ngx_http_scgi_create_request(ngx_http_request_t *r)
{
    ...
    if (params->lengths) {
        ...
        while (*(uintptr_t *) le.ip) {
            ...
            lcode = *(ngx_http_script_len_code_pt *) le.ip;
            IA2_CALL(lcode, _ZTSPFmP24ngx_http_script_engine_tE, 1)(&le); /* key length */
...
ngx_http_scgi_reinit_request(ngx_http_request_t *r)
{
    ...
    r->upstream->process_header = IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_http_scgi_process_status_line, _ZTSPFlP18ngx_http_request_sE, 1);
    r->state = 0;
...
ngx_http_scgi_process_status_line(ngx_http_request_t *r)
{
    ...
    if (rc == NGX_ERROR) {
        u->process_header = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_process_header, _ZTSPFlP18ngx_http_request_sE, 1);
    ...
    u->process_header = IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_http_scgi_process_header, _ZTSPFlP18ngx_http_request_sE, 1);
...
ngx_http_scgi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    {
        clcf->handler = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_scgi_handler, _ZTSPFlP18ngx_http_request_sE, 1);
    }
...
ngx_http_scgi_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    clcf = ngx_http_conf_get_module_loc_conf(cf, ngx_http_core_module);
    clcf->handler = IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_http_scgi_handler, _ZTSPFlP18ngx_http_request_sE, 1);
