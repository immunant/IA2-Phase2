...
IA2_DEFINE_WRAPPER(ngx_http_headers_expires, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_http_headers_add, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
...
static ngx_command_t  ngx_http_headers_filter_commands[] = {
    ...
    { ngx_string("expires"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_HTTP_LIF_CONF
                        |NGX_CONF_TAKE12,
      IA2_WRAPPER(ngx_http_headers_expires, 1),
    ...
    { ngx_string("add_header"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_HTTP_LIF_CONF
                        |NGX_CONF_TAKE23,
      IA2_WRAPPER(ngx_http_headers_add, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
...
IA2_DEFINE_WRAPPER(ngx_http_headers_create_conf, _ZTSPFPvP10ngx_conf_sE, 1);
IA2_DEFINE_WRAPPER(ngx_http_headers_filter_init, _ZTSPFlP10ngx_conf_sE, 1);
IA2_DEFINE_WRAPPER(ngx_http_headers_merge_conf, _ZTSPFPcP10ngx_conf_sPvS2_E, 1);

static ngx_http_module_t  ngx_http_headers_filter_module_ctx = {
    IA2_NULL_FNPTR,                                  /* preconfiguration */
    IA2_WRAPPER(ngx_http_headers_filter_init, 1),          /* postconfiguration */
    ...
    IA2_WRAPPER(ngx_http_headers_create_conf, 1),          /* create location configuration */
    IA2_WRAPPER(ngx_http_headers_merge_conf, 1)            /* merge location configuration */
};
...
ngx_http_headers_filter_init(ngx_conf_t *cf)
{
    ...
    ngx_http_top_header_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_headers_filter, _ZTSPFlP18ngx_http_request_sE, 1);

    ngx_http_next_body_filter = ngx_http_top_body_filter;
    ngx_http_top_body_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_trailers_filter, _ZTSPFlP18ngx_http_request_sP11ngx_chain_sE, 1);
