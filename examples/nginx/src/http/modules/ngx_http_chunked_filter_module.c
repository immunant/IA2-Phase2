...
IA2_DEFINE_WRAPPER(ngx_http_chunked_filter_init, _ZTSPFlP10ngx_conf_sE, 1);

static ngx_http_module_t  ngx_http_chunked_filter_module_ctx = {
    IA2_NULL_FNPTR,                                  /* preconfiguration */
    IA2_WRAPPER(ngx_http_chunked_filter_init, 1),          /* postconfiguration */
...
ngx_http_chunked_filter_init(ngx_conf_t *cf)
{
    ...
    ngx_http_top_header_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_chunked_header_filter, _ZTSPFlP18ngx_http_request_sE, 1);

    ngx_http_next_body_filter = ngx_http_top_body_filter;
    ngx_http_top_body_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_chunked_body_filter, _ZTSPFlP18ngx_http_request_sP11ngx_chain_sE, 1);
