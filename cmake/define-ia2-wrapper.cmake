...
# INPUT_DIR - Added to search path in rewriter invocation. Defaults to
#               SRC_DIR/include.
...
function(define_ia2_wrapper)
    ...
    set(oneValueArgs WRAPPER WRAPPED_LIB OUTPUT_HEADER OUTPUT_DIR INPUT_DIR
        COMPARTMENT_PKEY CALLER_PKEY)
    set(multiValueArgs HEADERS PRIVATE_HEADERS SHARED_HEADERS INCLUDE_DIRS)
    ...
    if(DEFINED DEFINE_IA2_WRAPPER_INPUT_DIR)
        set(INPUT_DIR ${DEFINE_IA2_WRAPPER_INPUT_DIR})
    else()
    ...
    if(DEFINED DEFINE_IA2_WRAPPER_INCLUDE_DIRS)
        set(INCLUDE_DIRS ${DEFINE_IA2_WRAPPER_INCLUDE_DIRS})
        list(TRANSFORM INCLUDE_DIRS PREPEND "-I")
    endif()

    # Collect headers
    set(ORIGINAL_HEADER_DIR ${INPUT_DIR})
    ...
    if(${DEFINE_IA2_WRAPPER_USE_SYSTEM_HEADERS})
        ...
        foreach(SYSTEM_HEADER ${HEADERS})
            ...
            if(NOT IS_ABSOLUTE ${SYSTEM_HEADER})
                set(SYSTEM_HEADER ${INPUT_DIR}/${SYSTEM_HEADER})
            endif()
