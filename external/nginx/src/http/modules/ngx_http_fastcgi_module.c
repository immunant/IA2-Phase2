...
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_lowat_check, _ZTSPFPcP10ngx_conf_sPvS2_E, 1);

static ngx_conf_post_t  ngx_http_fastcgi_lowat_post =
    { IA2_WRAPPER(ngx_http_fastcgi_lowat_check, 1) };
...
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_pass, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DECLARE_WRAPPER(ngx_conf_set_str_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_split_path_info, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_store, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_conf_set_access_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DECLARE_WRAPPER(ngx_conf_set_flag_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DECLARE_WRAPPER(ngx_http_upstream_bind_set_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
...
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_cache, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_cache_key, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DECLARE_WRAPPER(ngx_http_file_cache_set_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DECLARE_WRAPPER(ngx_http_set_predicate_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DECLARE_WRAPPER(ngx_http_file_cache_valid_set_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
...
IA2_DEFINE_WRAPPER(ngx_http_upstream_param_set_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);
IA2_DEFINE_WRAPPER(ngx_conf_set_str_array_slot, _ZTSPFPcP10ngx_conf_sP13ngx_command_sPvE, 1);

static ngx_command_t  ngx_http_fastcgi_commands[] = {

    { ngx_string("fastcgi_pass"),
      NGX_HTTP_LOC_CONF|NGX_HTTP_LIF_CONF|NGX_CONF_TAKE1,
      IA2_WRAPPER(ngx_http_fastcgi_pass, 1),
    ...
    { ngx_string("fastcgi_split_path_info"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      IA2_WRAPPER(ngx_http_fastcgi_split_path_info, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("fastcgi_store"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      IA2_WRAPPER(ngx_http_fastcgi_store, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("fastcgi_cache"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      IA2_WRAPPER(ngx_http_fastcgi_cache, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("fastcgi_cache_key"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      IA2_WRAPPER(ngx_http_fastcgi_cache_key, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
    ...
    { ngx_string("fastcgi_param"),
      ...
      IA2_WRAPPER(ngx_http_upstream_param_set_slot, 1),
      NGX_HTTP_LOC_CONF_OFFSET,
...
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_add_variables, _ZTSPFlP10ngx_conf_sE, 1);
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_create_main_conf, _ZTSPFPvP10ngx_conf_sE, 1);
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_create_loc_conf, _ZTSPFPvP10ngx_conf_sE, 1);
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_merge_loc_conf, _ZTSPFPcP10ngx_conf_sPvS2_E, 1);

static ngx_http_module_t  ngx_http_fastcgi_module_ctx = {
    IA2_WRAPPER(ngx_http_fastcgi_add_variables, 1),        /* preconfiguration */
    IA2_NULL_FNPTR,                                  /* postconfiguration */

    IA2_WRAPPER(ngx_http_fastcgi_create_main_conf, 1),     /* create main configuration */
    ...
    IA2_WRAPPER(ngx_http_fastcgi_create_loc_conf, 1),      /* create location configuration */
    IA2_WRAPPER(ngx_http_fastcgi_merge_loc_conf, 1)        /* merge location configuration */
};
...
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_script_name_variable, _ZTSPFlP18ngx_http_request_sP20ngx_variable_value_tmE, 1);
IA2_DEFINE_WRAPPER(ngx_http_fastcgi_path_info_variable, _ZTSPFlP18ngx_http_request_sP20ngx_variable_value_tmE, 1);

static ngx_http_variable_t  ngx_http_fastcgi_vars[] = {

    { ngx_string("fastcgi_script_name"), IA2_NULL_FNPTR,
      IA2_WRAPPER(ngx_http_fastcgi_script_name_variable, 1), 0,
      NGX_HTTP_VAR_NOCACHEABLE|NGX_HTTP_VAR_NOHASH, 0 },

    { ngx_string("fastcgi_path_info"), IA2_NULL_FNPTR,
      IA2_WRAPPER(ngx_http_fastcgi_path_info_variable, 1), 0,
      NGX_HTTP_VAR_NOCACHEABLE|NGX_HTTP_VAR_NOHASH, 0 },
...
ngx_http_fastcgi_handler(ngx_http_request_t *r)
{
    ...
    u->create_key = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_create_key, _ZTSPFlP18ngx_http_request_sE, 1);
#endif

    u->create_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_create_request, _ZTSPFlP18ngx_http_request_sE, 1);
    u->reinit_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_reinit_request, _ZTSPFlP18ngx_http_request_sE, 1);
    u->process_header = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_process_header, _ZTSPFlP18ngx_http_request_sE, 1);
    u->abort_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_abort_request, _ZTSPFvP18ngx_http_request_sE, 1);
    u->finalize_request = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_finalize_request, _ZTSPFvP18ngx_http_request_slE, 1);
    r->state = 0;
    ...
    u->pipe->input_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_input_filter, _ZTSPFlP16ngx_event_pipe_sP9ngx_buf_sE, 1);
    u->pipe->input_ctx = r;

    u->input_filter_init = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_input_filter_init, _ZTSPFlPvE, 1);
    u->input_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_non_buffered_filter, _ZTSPFlPvlE, 1);
    ...
    rc = ngx_http_read_client_request_body(r, IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_http_upstream_init, _ZTSPFvP18ngx_http_request_sE, 1));
...
ngx_http_fastcgi_create_request(ngx_http_request_t *r)
{
    ...
    if (params->lengths) {
        ...
        while (*(uintptr_t *) le.ip) {
            ...
            lcode = *(ngx_http_script_len_code_pt *) le.ip;
            skip_empty = IA2_CALL(lcode, _ZTSPFmP24ngx_http_script_engine_tE, 1)(&le);
    ...
    if (params->lengths) {
        ...
        while (*(uintptr_t *) le.ip) {
            ...
            lcode = *(ngx_http_script_len_code_pt *) le.ip;
            key_len = (u_char) IA2_CALL(lcode, _ZTSPFmP24ngx_http_script_engine_tE, 1)(&le);
    ...
    if (r->request_body_no_buffering) {
        ...
        u->output.output_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_body_output_filter, _ZTSPFlPvP11ngx_chain_sE, 1);
...
ngx_http_fastcgi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    {
        clcf->handler = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_handler, _ZTSPFlP18ngx_http_request_sE, 1);
    }
...
ngx_http_fastcgi_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    clcf->handler = IA2_DECLARE_WRAPPER_FN_SCOPE(ngx_http_fastcgi_handler, _ZTSPFlP18ngx_http_request_sE, 1);
