...
IA2_DEFINE_WRAPPER(ngx_http_static_init, _ZTSPFlP10ngx_conf_sE, 1);

static ngx_http_module_t  ngx_http_static_module_ctx = {
    IA2_NULL_FNPTR,                                  /* preconfiguration */
    IA2_WRAPPER(ngx_http_static_init, 1),                  /* postconfiguration */
...
ngx_http_static_init(ngx_conf_t *cf)
{
    ...
    *h = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_static_handler, _ZTSPFlP18ngx_http_request_sE, 1);
