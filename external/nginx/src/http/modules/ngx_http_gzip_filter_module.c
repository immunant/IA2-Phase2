...
static ngx_conf_num_bounds_t  ngx_http_gzip_comp_level_bounds = {
    IA2_FN(ngx_conf_check_num_bounds), 1, 9
};

static ngx_conf_post_handler_pt  ngx_http_gzip_window_p = IA2_FN(ngx_http_gzip_window);
static ngx_conf_post_handler_pt  ngx_http_gzip_hash_p = IA2_FN(ngx_http_gzip_hash);
...
static ngx_http_module_t  ngx_http_gzip_filter_module_ctx = {
    IA2_FN(ngx_http_gzip_add_variables),           /* preconfiguration */
    IA2_FN(ngx_http_gzip_filter_init),             /* postconfiguration */
    ...
    IA2_FN(ngx_http_gzip_create_conf),             /* create location configuration */
    IA2_FN(ngx_http_gzip_merge_conf)               /* merge location configuration */
};
...
ngx_http_gzip_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    if (ctx->nomem) {
        ...
        if (IA2_CALL(ngx_http_next_body_filter, 40, 1)(r, NULL) == NGX_ERROR) {
            goto failed;
        }
    ...
    ngx_http_gzip_ctx_t *ctx)
{
    ...
    ctx->zstream.zalloc = (void*)&__ia2_ngx_http_gzip_filter_alloc;
    ctx->zstream.zfree = (void*)&__ia2_ngx_http_gzip_filter_free;
...
ngx_http_gzip_add_variables(ngx_conf_t *cf)
{
    ...
    var->get_handler = IA2_FN(ngx_http_gzip_ratio_variable);
...
ngx_http_gzip_filter_init(ngx_conf_t *cf)
{
    ...
    ngx_http_top_header_filter = IA2_FN(ngx_http_gzip_header_filter);

    ngx_http_next_body_filter = ngx_http_top_body_filter;
    ngx_http_top_body_filter = IA2_FN(ngx_http_gzip_body_filter);
...
IA2_DEFINE_WRAPPER_ngx_http_gzip_add_variables
IA2_DEFINE_WRAPPER_ngx_http_gzip_body_filter
IA2_DEFINE_WRAPPER_ngx_http_gzip_create_conf
IA2_DEFINE_WRAPPER_ngx_http_gzip_filter_alloc
IA2_DEFINE_WRAPPER_ngx_http_gzip_filter_free
IA2_DEFINE_WRAPPER_ngx_http_gzip_filter_init
IA2_DEFINE_WRAPPER_ngx_http_gzip_hash
IA2_DEFINE_WRAPPER_ngx_http_gzip_header_filter
IA2_DEFINE_WRAPPER_ngx_http_gzip_merge_conf
IA2_DEFINE_WRAPPER_ngx_http_gzip_ratio_variable
IA2_DEFINE_WRAPPER_ngx_http_gzip_window
