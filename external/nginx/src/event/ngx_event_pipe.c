...
ngx_event_pipe_read_upstream(ngx_event_pipe_t *p)
{
    ...
    for ( ;; ) {
        ...
        if (p->preread_bufs) {
            ...
            n = IA2_CALL(p->upstream->recv_chain, 28, 1)(p->upstream, chain, limit);
        ...
        while (cl && n > 0) {
            ...
            if (n >= size) {
                ...
                if (IA2_CALL(p->input_filter, 29, 1)(p, cl->buf) == NGX_ERROR) {
                    return NGX_ABORT;
                }
    ...
    if ((p->upstream_eof || p->upstream_error) && p->free_raw_bufs) {
        ...
        if (IA2_CALL(p->input_filter, 29, 1)(p, p->free_raw_bufs->buf) == NGX_ERROR) {
            return NGX_ABORT;
        }
...
ngx_event_pipe_write_to_downstream(ngx_event_pipe_t *p)
{
    ...
    for ( ;; ) {
        ...
        if (p->upstream_eof || p->upstream_error || p->upstream_done) {
            ...
            if (p->out) {
                ...
                rc = IA2_CALL(p->output_filter, 5, 1)(p->output_ctx, p->out);
            ...
            if (p->in) {
                ...
                rc = IA2_CALL(p->output_filter, 5, 1)(p->output_ctx, p->in);
    ...
    flush:
        ...
        rc = IA2_CALL(p->output_filter, 5, 1)(p->output_ctx, out);
