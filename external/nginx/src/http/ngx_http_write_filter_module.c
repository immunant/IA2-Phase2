...
IA2_DEFINE_WRAPPER(ngx_http_write_filter_init, _ZTSPFlP10ngx_conf_sE, 1);

static ngx_http_module_t  ngx_http_write_filter_module_ctx = {
    IA2_NULL_FNPTR,                                  /* preconfiguration */
    IA2_WRAPPER(ngx_http_write_filter_init, 1),            /* postconfiguration */
...
ngx_http_write_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    *ll = NULL;
    ...
    chain = IA2_CALL(c->send_chain, _ZTSPFP11ngx_chain_sP16ngx_connection_sS0_lE, 1)(c, r->out, limit);
...
{
    ngx_http_top_body_filter = IA2_DEFINE_WRAPPER_FN_SCOPE(ngx_http_write_filter, _ZTSPFlP18ngx_http_request_sP11ngx_chain_sE, 1);
