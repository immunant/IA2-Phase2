...
static ngx_conf_num_bounds_t  ngx_http_uwsgi_modifier_bounds = {
    IA2_FN(ngx_conf_check_num_bounds), 0, 255
};
...
static ngx_command_t ngx_http_uwsgi_commands[] = {
    ...
    { ngx_string("uwsgi_cache_key"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      IA2_FN(ngx_http_uwsgi_cache_key),
      NGX_HTTP_LOC_CONF_OFFSET,
      0,
      NULL },
...
static ngx_http_module_t ngx_http_uwsgi_module_ctx = {
    ...
    IA2_FN(ngx_http_uwsgi_create_main_conf),       /* create main configuration */
    NULL,                                  /* init main configuration */

    NULL,                                  /* create server configuration */
    NULL,                                  /* merge server configuration */

    IA2_FN(ngx_http_uwsgi_create_loc_conf),        /* create location configuration */
    IA2_FN(ngx_http_uwsgi_merge_loc_conf)          /* merge location configuration */
};
...
ngx_http_uwsgi_handler(ngx_http_request_t *r)
{
    ...
    u->create_key = IA2_FN(ngx_http_uwsgi_create_key);
#endif

    u->create_request = IA2_FN(ngx_http_uwsgi_create_request);
    u->reinit_request = IA2_FN(ngx_http_uwsgi_reinit_request);
    u->process_header = IA2_FN(ngx_http_uwsgi_process_status_line);
    u->abort_request = IA2_FN(ngx_http_uwsgi_abort_request);
    u->finalize_request = IA2_FN(ngx_http_uwsgi_finalize_request);
    r->state = 0;
    ...
    u->input_filter_init = IA2_FN(ngx_http_uwsgi_input_filter_init);
...
ngx_http_uwsgi_reinit_request(ngx_http_request_t *r)
{
    ...
    r->upstream->process_header = IA2_FN(ngx_http_uwsgi_process_status_line);
    r->state = 0;
...
ngx_http_uwsgi_process_status_line(ngx_http_request_t *r)
{
    ...
    if (rc == NGX_ERROR) {
        u->process_header = IA2_FN(ngx_http_uwsgi_process_header);
...
ngx_http_uwsgi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    {
        clcf->handler = IA2_FN(ngx_http_uwsgi_handler);
    }
...
#endif
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_abort_request
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_cache
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_cache_key
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_create_key
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_create_loc_conf
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_create_main_conf
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_create_request
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_finalize_request
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_handler
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_input_filter_init
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_merge_loc_conf
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_pass
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_process_header
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_process_status_line
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_reinit_request
IA2_DEFINE_WRAPPER_ngx_http_uwsgi_store
