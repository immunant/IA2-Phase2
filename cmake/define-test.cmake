...
function(define_shared_lib)
    ...
    if(DEFINED SHARED_LIB_LIBNAME)
        ...
        set(WRAPPED_LIBNAME ${SHARED_LIB_LIBNAME}_wrapped)
    else()
        set(LIBNAME ${TEST_NAME}_lib)
        set(WRAPPED_LIBNAME ${TEST_NAME}_lib_wrapped)
    endif()
    ...
    add_custom_target(copy_files_${LIBNAME}
        ...
        COMMAND cp -r --parents ${RELATIVE_INCLUDE_DIR} ${CMAKE_CURRENT_BINARY_DIR}/
    ...
    file(COPY ${ORIGINAL_SRCS} DESTINATION ${CMAKE_CURRENT_BINARY_DIR})
